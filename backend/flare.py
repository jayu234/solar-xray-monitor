...
Original file is located at
    https://colab.research.google.com/drive/1hQClBQjuaaeCqPmpcmtsW-JIToeyWG7b
...
"""### Preprocessing
Refer <a href="./Preprocessing.ipynb">Preprocessing.ipynb</a> for further details
"""
...
"""### Functions
Following are the functions used to model a sample flare.
...
- Public:
    - **time, rate**: Processed time, rate
    - **s, p, e**: The observed start, peak and end of each flare
    - **background**: The background i.e. the global minima of the entire data
    - **s_calc, e_calc**: The calculated start and end time of each flare, post curve fitting
    - **classes**: The class of each flare
    - **data**: A pandas DataFrame of the above data
"""
...
path_to_lc = '/content/ch2_xsm_20200928_v1_level2.lc'
